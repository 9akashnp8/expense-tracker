...
class Account(models.Model):
    ...
    starting_balance = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    latest_balance = models.DecimalField(max_digits=4, decimal_places=2, default=0)
